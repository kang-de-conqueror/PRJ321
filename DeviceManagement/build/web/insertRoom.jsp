<%-- 
    Document   : insertRoom
    Created on : Mar 16, 2020, 12:33:14 AM
    Author     : Peter
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container w-50">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center">Insert Room</h3>
                    <form action="MainController" method="POST">
                        <div class="form-group row">
                            <label for="txtRoomID" class="col-sm-2 col-form-label">Room id:</label>
                            <div class="col-sm-10">
                                <input type="text" name="txtRoomID" class="form-control" id="txtRoomID" />
                            </div>
                        </div>
                        <c:if test="${requestScope.INVALID_ROOM.roomIDError != null}">
                            <font color="red">${requestScope.INVALID_ROOM.roomIDError}</font>
                        </c:if>
                        <div class="form-group row">
                            <label for="txtRoomName" class="col-sm-2 col-form-label">Room name:</label>
                            <div class="col-sm-10">
                                <input type="text" name="txtRoomName" class="form-control" id="txtRoomName" />
                            </div>
                        </div>
                        ...
                        <div class="w-100 d-flex justify-content-center">
                            <input type="submit" name="action" value="Insert Room" class="btn btn-success"/>
                        </div>
                    </form>
                </div>
            </div>
