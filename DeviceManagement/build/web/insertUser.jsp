<%-- 
    Document   : insertUser
    Created on : Mar 16, 2020, 12:33:03 AM
    Author     : Peter
--%>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="MainController" method="POST">
                        ...
                        <c:if test="${requestScope.INVALID_USER.passwordError != null}">
                            <font color="red">${requestScope.INVALID_USER.passwordError}</font>
                        </c:if>

                        <div class="form-group row">
                            <label for="txtConfirm" class="col-sm-2 col-form-label">Confirm</label>
                            <div class="col-sm-10">
                                <input type="password" name="txtConfirm" class="form-control" id="txtConfirm" />
                            </div>
                        </div>
                        <c:if test="${requestScope.INVALID_USER.confirmError != null}">
                            <font color="red">${requestScope.INVALID_USER.confirmError}</font>
                        </c:if>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtRole" class="form-control" id="txtRole" />
                            </div>
                        </div>
                        ...
                        <div class="w-100 d-flex justify-content-center">
                            <input type="submit" name="action" value="Insert User" class="btn btn-success"/>
                        </div>
                    </form>
                </div>
            </div>
