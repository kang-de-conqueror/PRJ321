<%-- 
    Document   : insertDevice
    Created on : Mar 16, 2020, 12:33:22 AM
    Author     : Peter
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container w-50">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center">Insert Device</h3>
                    <form action="MainController" method="POST">
                        <div class="form-group row">
                            <label for="txtDeviceName" class="col-sm-2 col-form-label">Name:</label>
                            <div class="col-sm-10">
                                <input type="text" name="txtDeviceName" class="form-control" id="txtDeviceName" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtDeviceDescription" class="form-control" id="txtDeviceDescription" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtDeviceType" class="form-control" id="txtDeviceType" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtDeviceState" class="form-control" id="txtDeviceState" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" accept="image/*" name="txtDeviceImage" class="form-control-file" id="txtDeviceImage" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="txtBuyDate" class="form-control" id="txtBuyDate" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="txtGuaranteeDuration" class="col-sm-2 col-form-label">Guarantee:</label>
                            <div class="col-sm-10">
                                <input type="text" name="txtGuaranteeDuration" class="form-control" id="txtGuaranteeDuration" />
                            </div>
                        </div>
                        ...
                        <div class="w-100 d-flex justify-content-center">
                            <input type="submit" name="action" value="Insert Device" class="btn btn-success"/>
                        </div>
                    </form>
                </div>
            </div>
