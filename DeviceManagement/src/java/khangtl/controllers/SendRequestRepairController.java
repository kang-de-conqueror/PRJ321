 ...
 * @author Peter
 */
public class SendRequestRepairController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at SendRequestRepairController: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("requestRepair.jsp").forward(request, response);
        }
    }
